...
if($_POST){
        ...
        if($_POST['name'] && $_POST['email'] && $_POST['password']){
            ...
            $user = new User($database->getConnection(), $_POST['name'], $_POST['email'], $_POST['password']);
            // var_dump($user);
            // Avec l'aide d'un composant il va créer un utilisateur qui prendra prendra comme paramètre le nom, le mail et le mot de passe.
            $user->create();
